...
In the LM Studio application, press Cmd / Ctrl + L to open the model loader. Here you can view a list of downloaded models and select one to load. LM Studio will by default select the load parameters that optimizes model performance on your hardware.
...
Learn more about how to do this https://lmstudio.ai/docs/developer.
